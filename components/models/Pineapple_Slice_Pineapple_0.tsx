...
type GLTFResult = GLTF & {
  nodes: {
    Pineapple_Slice_Pineapple_0: THREE.Mesh;
  };
  materials: {
...
export function PineappleInstances({
  children,
  ...props
  ...
  const instances = React.useMemo(
    () => ({
      PineappleSlicePineapple: nodes.Pineapple_Slice_Pineapple_0,
    }),
    [nodes]
  );
  return (
...
export function PineappleModel(
  ...
  return (
    <group
      ...
      dispose={null}
    >
      <instances.PineappleSlicePineapple scale={0.01} />
    </group>
  );
}
