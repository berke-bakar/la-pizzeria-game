...
type GLTFResult = GLTF & {
  nodes: {
    Mushroom_Slice_Mushroom_0: THREE.Mesh;
  };
  materials: {
...
export function MushroomInstances({
  ...
  const instances = React.useMemo(
    () => ({
      MushroomSliceMushroom: nodes.Mushroom_Slice_Mushroom_0,
    }),
    [nodes]
  );
  return (
...
export function MushroomModel(props: JSX.IntrinsicElements["group"]) {
  ...
  return (
    <group
      ...
      dispose={null}
    >
      <instances.MushroomSliceMushroom scale={0.01} />
    </group>
  );
}

useGLTF.preload(
  Asset.fromModule(require("../../assets/models/Mushroom_Slice_Mushroom_0.glb"))
    .uri
);
