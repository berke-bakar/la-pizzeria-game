...
export function Olive0Instances({
  children,
  ...props
}: JSX.IntrinsicElements["group"]) {
  const { nodes } = useGLTF(
    Asset.fromModule(require("../../assets/models/Olive_Slice_Oilives_0.glb"))
      .uri
  ) as GLTFResult;
  const instances = React.useMemo(
    () => ({
      OliveSliceOilives: nodes.Olive_Slice_Oilives_0,
    }),
    [nodes]
  );
  return (
...
export function Olive0Model(props: JSX.IntrinsicElements["group"]) {
...
useGLTF.preload(
  Asset.fromModule(require("../../assets/models/Olive_Slice_Oilives_0.glb")).uri
);
