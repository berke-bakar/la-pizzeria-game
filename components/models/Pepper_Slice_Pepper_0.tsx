...
export function Pepper0Instances({
  children,
  ...props
}: JSX.IntrinsicElements["group"]) {
  const { nodes } = useGLTF(
    Asset.fromModule(require("../../assets/models/Pepper_Slice_Pepper_0.glb"))
      .uri
  ) as GLTFResult;
  const instances = React.useMemo(
    () => ({
      PepperSlicePepper: nodes.Pepper_Slice_Pepper_0,
    }),
    [nodes]
  );
  return (
...
export function Pepper0Model(props: JSX.IntrinsicElements["group"]) {
...
useGLTF.preload(
  Asset.fromModule(require("../../assets/models/Pepper_Slice_Pepper_0.glb")).uri
);
