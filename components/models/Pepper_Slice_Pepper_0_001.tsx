...
type GLTFResult = GLTF & {
  nodes: {
    Pepper_Slice_Pepper_0001: THREE.Mesh;
  };
  materials: {
...
export function Pepper1Instances({
  children,
  ...props
}: JSX.IntrinsicElements["group"]) {
  const { nodes } = useGLTF(
    Asset.fromModule(
      require("../../assets/models/Pepper_Slice_Pepper_0_001.glb")
    ).uri
  ) as GLTFResult;
  const instances = React.useMemo(
    () => ({
      PepperSlicePepper: nodes.Pepper_Slice_Pepper_0001,
    }),
    [nodes]
  );
  return (
...
export function Pepper1Model(props: JSX.IntrinsicElements["group"]) {
...
useGLTF.preload(
  Asset.fromModule(require("../../assets/models/Pepper_Slice_Pepper_0_001.glb"))
    .uri
);
